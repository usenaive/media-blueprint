...
export const LONGFORM: MediaTemplate = {
   ...
   *     pieces (`REFERENCE_STUDY_RULE`), which is the change that stopped this crew planning blind, and
  ...
  tasks: [
     ...
     * rewritten rules keep the ban on INVENTING a reference and drop the ban on
