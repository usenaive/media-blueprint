...
describe("mcp tools", () => {
  ...
  it("create_project files a generation plan on its brief, which moves to scripted with the plan on it", async () => {
    ...
    const scenes = [
      ...
      { prompt: "A hand pushing a soft mattress away", seconds: 5, voiceover: "Comfort, he said, is the thing you should fear.", model: VIDEO_MODELS[1] },
    ];
    ...
    // No model named: the plan takes the crew's default, which is the first pin.
